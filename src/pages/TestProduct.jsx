...
const TestProduct = () => {
  ...
  useEffect(() => {
    const filteredTrendingProducts = item.filter(
      (item) => item.category === "basketball"
    );

    const filteredBestSalesProducts = item.filter(
      (item) => item.category === "running"
    );

    const filteredPopularProducts = item.filter(
      ...
      <section className="trending__products">
        <Container>
          <Row>
            ...
            <ProductsListTest data={trendingProducts} />
          </Row>
        </Container>
      </section>
      ...
      <section className="best__sales">
        <Container>
          <Row>
            ...
            <ProductsListTest data={bestSalesProducts} />
          </Row>
        </Container>
      </section>
      ...
      <section className="popular__category">
        <Container>
          <Row>
            ...
            <ProductsListTest data={popularProducts} />
          </Row>
        </Container>
      </section>
      <section className="popular__category">
        <Container>
          <Row>
            ...
            <ProductsListTest data={cartItems} />
          </Row>
        </Container>
      </section>
    </Helmet>
